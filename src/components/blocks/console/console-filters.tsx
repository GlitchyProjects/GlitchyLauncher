    ...
    <div className="flex shrink-0 flex-col gap-2 pb-2 sm:pb-3">
      <div className="flex w-full items-center justify-between gap-2 rounded-2xl border border-border/40 bg-secondary/30 p-1.5">
        ...
        <div className="flex items-center gap-1.5">
          <NavLink
            className="flex h-8 shrink-0 items-center gap-1.5 rounded-xl border border-primary/30 bg-primary/10 px-2.5 font-semibold text-primary text-xs transition-all hover:bg-primary/20"
            title="Diagnose with AI"
            to="/assistant"
          >
            <Sparkles className="size-3.5" />
            <span className="hidden sm:inline">Diagnose with AI</span>
          </NavLink>
